...
public class PersonModificationTest extends BaseTest {
  ...
  public void testPersonModification() {
    ...
    applicationManager.getPersonHelper().fillPersonForm(new PersonData("new first name", "new middle name", "new last name", "new nickname", "new  title", "new company", "880099988877", "test1@test.com", null));
